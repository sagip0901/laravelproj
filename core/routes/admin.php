...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('OpenAIController')->name('open.ai.')->prefix('open-ai')->group(function () {
        Route::prefix('model')->name('model.')->group(function () {
            Route::get('index', 'models')->name('index');
            Route::post('status/{id}', 'modelStatus')->name('status');
        });
        Route::prefix('setting')->name('setting.')->group(function () {
            Route::get('index', 'setting')->name('index');
    ...
    Route::controller('ChatBotController')->name('chat.bot.')->prefix('chat-bot')->group(function () {
        Route::get('', 'index')->name('index');
        Route::post('store/{id?}', 'store')->name('store');
        Route::post('status/{id}', 'status')->name('status');
    });
    ...
    Route::controller('ReportController')->prefix('report')->name('report.')->group(function () {
        ...
        Route::get('document/history', 'documentHistory')->name('document.history');
