                                ...
                                @forelse($users as $user)
                                    <tr>
                                        ...
                                        <td><span class="fw-bold"
                                                title="{{ @$user->address->country }}">{{ $user->country_code }}</span></td>
                                        <td>
                                        ...
                                        <td>
                                            <span class="fw-bold">{{ @$user->balanceLimit['word_limit'] }}</span>
                                        </td>
                                        <td>
                                            <span class="fw-bold">{{ @$user->balanceLimit['image_limit'] }}</span>
                                        </td>
                                        <td>
                                            <span class="fw-bold">{{ @$user->balanceLimit['minute_limit'] }}</span>
                                        </td>
