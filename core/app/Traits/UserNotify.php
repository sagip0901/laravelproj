...
trait UserNotify {
    public static function notifyToUser() {
        return [
            ...
            'allSubscribedUser'      => 'All Subscribed User',
            'unSubscribedUser'       => 'Not Subscribed User',
            'expiredSubscribedUser'  => 'Expired Subscribed User',
        ];
    }
    ...
    public function scopeAllSubscribedUser($query) {
        return $query->where('expired_date', '>', now());
    }

    public function scopeUnSubscribedUser($query) {
        return $query->where('plan_id', 0);
    }

    public function scopeExpiredSubscribedUser($query) {
        return $query->where('expired_date', '<', now());
    }
