...
class GeneralSettingController extends Controller {
    ...
    public function generalUpdate(Request $request) {
        ...
        $general->third_color        = str_replace('#', '', $request->third_color);
        $general->currency_format    = $request->currency_format;
        $general->register_bonus     = $request->register_bonus;
        $general->subscription_bonus = $request->subscription_bonus;
        $general->weather_api_key    = $request->weather_api_key;
        $general->save();
    ...
    public function systemConfigurationSubmit(Request $request) {
        ...
        $general->weather                 = $request->weather ? Status::ENABLE : Status::DISABLE;
        $general->subscription_commission = $request->subscription_commission ? Status::ENABLE : Status::DISABLE;
        $general->register_commission     = $request->register_commission ? Status::ENABLE : Status::DISABLE;
        $general->save();
    ...
    public function logoIconUpdate(Request $request) {
        $request->validate([
            ...
            'preloader' => ['image', new FileTypeValidate(['jpg', 'jpeg', 'png'])],
        ...
        if ($request->hasFile('preloader')) {
            try {
                fileUploader($request->preloader, $path, filename: 'preloader.png');
            } catch (\Exception $exp) {
