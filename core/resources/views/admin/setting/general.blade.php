                    ...
                    <form method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4 col-sm-6">
                                <label> @lang('Site Third Color')</label>
                                <div class="input-group">
                                    <span class="input-group-text p-0 border-0">
                                        <input type='text' class="form-control colorPicker" value="{{ gs('third_color') }}" />
                                    </span>
                                    <input type="text" class="form-control colorCode" name="third_color" value="{{ gs('third_color') }}" />
                                </div>
                            </div>

                            <div class="col-md-12 col-sm-6">
                                <div class="form-group">
                                    <label>@lang('Weather API Key')</label>
                                    <input type="text" name="weather_api_key" class="form-control" value="{{ gs('weather_api_key') }}">
                                    <code><i class="las la-exclamation-triangle"></i>@lang('note Here you need to use the Weather API Key. You get the key from this link') <a href="https://www.weatherapi.com/pricing.aspx" target="_blank">@lang('click here')</a></code>
                                </div>
                            </div>

                            <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                    <label>@lang('Register Referral Bonus')</label>
                                    <div class="input-group">
                                        <input type="number" name="register_bonus" step="any" class="form-control" value="{{ getAmount(gs('register_bonus')) }}">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                    <label>@lang('Subscription Referral Bonus')</label>
                                    <div class="input-group">
                                        <input type="number" name="subscription_bonus" step="any" class="form-control" value="{{ getAmount(@gs('subscription_bonus')) }}">
