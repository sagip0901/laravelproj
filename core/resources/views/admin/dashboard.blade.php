...
@section('panel')
    ...
    <div class="row gy-4 mt-2">
        ...
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                style="6"
                link="{{ route('admin.template.index') }}"
                title="Total Template"
                icon="las la-pager"
                value="{{ $widget['total_template'] }}"
                bg="warning"
                outline="true"
            />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                style="6"
                link="{{ route('admin.chat.bot.index') }}"
                title="Total ChatBot"
                icon="lab la-rocketchat"
                value="{{ $widget['total_chatBot'] }}"
                bg="danger"
                outline="true"
            />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                style="6"
                link="{{ route('admin.ticket.pending') }}"
                title="Pending Ticket"
                icon="la la-ticket"
                value="{{ $widget['pending_ticket'] }}"
                bg="primary"
                outline="true"
            />
        </div><!-- dashboard-w1 end -->
