                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="form-group col-md-6 col-sm-6">
                                ...
                                <x-image-uploader name="dark_logo" :imagePath="siteLogo('dark') . '?' . time()" :size="false" class="dark-style w-100" id="uploadDarkLogo" :required="false" />
                            </div>
                            ...
                            <div class="form-group col-md-6 col-sm-6">
                                ...
                                <x-image-uploader name="preloader" :imagePath="preloaderImage() . '?' . time()" :size="false" class="w-100 " id="uploadPreloader" :required="false" />
                            </div>
                        </div>
...
@push('style')
    <style>
        .dark-style .image-upload-preview {
